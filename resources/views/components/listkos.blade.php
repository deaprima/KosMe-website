<!-- List Kos Start -->
<div id="listkos" class="container py-5">
    ...
    <div class="mt-5 text-center col-12 wow fadeInUp" data-wow-delay="0.1s">
        <a class="py-3 ppx-5 btn btn-primary" href="{{ route('boarding-house.search') }}">Lihat Semua</a>
    </div>
</div>
